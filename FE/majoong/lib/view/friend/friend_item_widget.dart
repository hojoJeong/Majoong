...
import 'package:majoong/view/video/guardian_video_screen.dart';
...
class FriendItemWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return GestureDetector(
      onTap: () {
        ref.read(videoProvider.notifier).getFriendRecordings(friendId);
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => GuardianVideoScreen()));
      },
      child: Slidable(
