...
class GuardianVideoScreen extends ConsumerWidget {
  const GuardianVideoScreen({Key? key}) : super(key: key);
            ...
            ? Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(
                      '보호자로 등록된 사용자만 조회가 가능합니다',
                      style: TextStyle(color: Colors.grey),
                    ),
                  ],
                ),
              )
            : videoInfo.data!.length == 0
                ? Center(
                  child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      (videoInfo.data![index].duration / 60)
                                                  .toInt() >
                                              0
