...
final reviewDialogProvider = StateNotifierProvider<ReviewDialogNotifier, WriteReviewRequestDto>((ref) {
...
class ReviewDialogNotifier extends StateNotifier<WriteReviewRequestDto> {
  ...
  ReviewDialogNotifier(this.currentLocation) : super(WriteReviewRequestDto(0,0,'',0,false,false,null,'')) {}
