...
final loginProvier =
  ...
  final notifier = LoginStateNotifier(userApi: userApi, request: loginRequest, secureStorage: secureStorage);
  return notifier;
});
...
class LoginStateNotifier extends StateNotifier<BaseResponseState> {
  ...
  LoginStateNotifier({required this.userApi, required this.request, required this.secureStorage})
